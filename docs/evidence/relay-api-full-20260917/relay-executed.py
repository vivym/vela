...
root=pathlib.Path('/opt/vela-cluster/relay-api-full-20260917');root.mkdir(mode=0o700,exist_ok=True)
...
request=json.loads(pathlib.Path('/opt/vela-cluster/h3-api-acceptance-20260917-minimax-v8/request.json').read_text());request['prompt']='清晨的海边，一艘蓝色帆船缓慢驶过，镜头平稳推进，保留自然海浪声与海鸟鸣叫。';request['client_metadata']={'relay_order_id':'relay-integration-20260917-full','external_user_id':'验收用户','integer_order_id':9007199254740993}
