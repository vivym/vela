...
2026-09-17 22:32（Asia/Shanghai）更新：**修复已同步并完成正式模型真实验收**。
11 个 GPU 实例均已应用最新 Runtime/Worker Agent，忙时受理、取消恢复、后续完整
音视频、幂等和唯一计费均通过，详见[最新修复版部署与验收](h3-minimax-v10-latest-fix-deployment-2026-09-17.md)。

以下保留升级前的差异证据与发布要求，表中“当前”均指当时核查时点。

## 升级前核查记录

2026-09-17 19:15（Asia/Shanghai）现场核查结果：**当时尚未全部同步**。
