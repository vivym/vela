...
| Barman Cloud Plugin And PITR Conformance | `4f4bc2d` | `docs/specs/0038-barman-cloud-plugin-and-pitr-conformance.md`, `deploy/control-storage`, `hack/test-cnpg-pitr.sh` |
...
Production Gate.
Slice 38 (`4f4bc2d`) replaces the deprecated native CNPG backup integration
with a pinned Barman Cloud Plugin contract and proves a real local base backup,
