...
| 0013 Non-interrupting releases | Partial | Twenty-five additive migrations, exact N/N-1 database/control compatibility, operator-receipted circuit and Fleet Assignment protocol transitions, Protobuf/OpenAPI breaking checks, and migration down/up evidence. | Deployed Worker/event/API rollout, drain, rollback, and retained-backlog receipts. |
...
The committed repository coverage is now 25 direct, 3 partial, and 2 unproven.
Scenarios 18 and 26 remain unproven until later slices or production
